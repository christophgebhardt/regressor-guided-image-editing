...
from external.imaginaire.discriminators.multires_patch import MultiResPatchDiscriminator
from external.imaginaire.discriminators.residual import ResDiscriminator
